...
const profile = {
    ...
    skills: [
        'React', 'Redux', 'Express', 'JavaScript'
        'MySQL', 'MongoDB', 'MS AZURE', 'TypeScript',
        'Git', 'Linux', 'Java', 'python', 'C++'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
          ...
          >
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                ...
                Full-stack Developer ⚙️ | React & Node.js Enthusiast ⚛️🌐 | Building smart tools & AI-driven web experiences 🤖📊
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/Brown-Sage"
                ...
                {/* Contact Button */}
                <a
                  href="https://drive.google.com/file/d/1GHG69lWrcIooykbSmQ98p4Jm9ZdoOI4e/view?usp=sharing"
                  target="_blank"
